<?php
/**
 * Шорткод для отображения ленты креатора
 * Компактное отображение информации о креаторе с возможностью копирования
 */
    ...
    <div id="<?php echo esc_attr($uid); ?>" class="copella-creator-card <?php echo esc_attr($style_class); ?>">
        ...
        <?php if ($options['copy_shortcode'] !== 'false'): ?>
            <div class="cp-copy-shortcode">
                <button type="button" class="cp-copy-btn" data-creator-id="<?php echo esc_attr($creator_id); ?>" title="<?php _e('Скопировать шорткод', 'copella-creators'); ?>">
            ...
            <div class="cp-card-info">
                ...
                <?php if ($age || $experience): ?>
                    <div class="cp-card-stats">
                        <?php if ($age): ?>
                            <span class="cp-card-stat"><?php echo esc_html($age); ?> <?php _e('лет', 'copella-creators'); ?></span>
                        <?php endif; ?>
                        <?php if ($experience): ?>
        ...
        <?php if (!empty($achievements) && $options['show_achievements'] !== 'false'): ?>
            <div class="cp-card-achievements">
                <h4 class="cp-card-section-title"><?php _e('Достижения', 'copella-creators'); ?></h4>
                <div class="cp-card-achievements-list">
                    ...
                    <?php if (count($achievements) > 3): ?>
                        <div class="cp-card-more">
                            +<?php echo count($achievements) - 3; ?> <?php _e('еще', 'copella-creators'); ?>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <?php if (!empty($social_networks) && $options['show_social'] !== 'false'): ?>
            <div class="cp-card-social">
                <h4 class="cp-card-section-title"><?php _e('Социальные сети', 'copella-creators'); ?></h4>
                <div class="cp-card-social-list">
                    ...
                    <?php if (count($social_networks) > 4): ?>
                        <div class="cp-card-more">
                            +<?php echo count($social_networks) - 4; ?> <?php _e('еще', 'copella-creators'); ?>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <?php if (!empty($playlists) && $options['show_playlists'] !== 'false'): ?>
            <div class="cp-card-playlists">
                <h4 class="cp-card-section-title"><?php _e('Плейлисты', 'copella-creators'); ?></h4>
        ...
        <?php if (!empty($projects) && $options['show_projects'] !== 'false'): ?>
            <div class="cp-card-projects">
                <h4 class="cp-card-section-title"><?php _e('Проекты', 'copella-creators'); ?></h4>
        ...
        <div class="cp-card-footer">
            <a href="<?php echo esc_url(get_permalink($creator_id)); ?>" class="cp-card-link">
                <?php _e('Подробнее о креаторе', 'copella-creators'); ?>
                <svg viewBox="0 0 24 24" width="16" height="16">
...
add_shortcode('creators_list', function($atts): string {
    ...
    if (empty($creators)) {
        return '<p>' . __('Креаторы не найдены', 'copella-creators') . '</p>';
    }
