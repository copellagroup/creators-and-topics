        ...
        <div class="cp-single-content">
            ...
            <?php if (!empty($description)): ?>
                <section class="cp-single-section cp-single-description">
                    <h2 class="cp-single-section-title"><?php _e('О креаторе', 'copella-creators'); ?></h2>
            ...
            <?php if (!empty($achievements)): ?>
                <section class="cp-single-section cp-single-achievements">
                    <h2 class="cp-single-section-title"><?php _e('Достижения и заслуги', 'copella-creators'); ?></h2>
            ...
            <?php if (!empty($social_networks)): ?>
                <section class="cp-single-section cp-single-social">
                    <h2 class="cp-single-section-title"><?php _e('Социальные сети', 'copella-creators'); ?></h2>
            ...
            <?php if (!empty($playlists)): ?>
                <section class="cp-single-section cp-single-playlists">
                    <h2 class="cp-single-section-title"><?php _e('Плейлисты', 'copella-creators'); ?></h2>
                            ...
                            <div class="cp-single-playlist-card">
                                <a href="<?php echo esc_url(get_permalink($playlist->ID)); ?>" class="cp-single-playlist-link">
                                    ...
                                    <div class="cp-single-playlist-info">
                                        ...
                                        <div class="cp-single-playlist-meta"><?php _e('Плейлист', 'copella-creators'); ?></div>
                                    </div>
                                </a>
                            </div>
                        <?php endforeach; ?>
            ...
            <?php if (!empty($projects)): ?>
                <section class="cp-single-section cp-single-projects">
                    <h2 class="cp-single-section-title"><?php _e('Проекты', 'copella-creators'); ?></h2>
...
<style>
/* Стили для полноценной страницы креатора в стиле Topics Plugin */
