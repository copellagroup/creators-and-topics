...
<div class="copella-creators-archive">
    <header class="cp-archive-header">
        <h1 class="cp-archive-title"><?php _e('Все креаторы', 'copella-topics'); ?></h1>
        <div class="cp-archive-description">
            <?php _e('Познакомьтесь с нашими талантливыми креаторами', 'copella-topics'); ?>
        </div>
    </header>
        ...
        <?php if (have_posts()) : ?>
                    ...
                    <article class="cp-creator-card">
                        <a href="<?php echo esc_url(get_permalink()); ?>" class="cp-creator-link">
                            ...
                            <div class="cp-creator-info">
                                ...
                                <?php endif; ?>
                                <?php if ($age): ?>
                                    <div class="cp-creator-age"><?php echo esc_html($age); ?> <?php _e('лет', 'copella-topics'); ?></div>
                                <?php endif; ?>
            ...
            <div class="cp-archive-pagination">
                ...
                the_posts_pagination(array(
                    'mid_size' => 2,
                    'prev_text' => __('← Предыдущая', 'copella-topics'),
                    'next_text' => __('Следующая →', 'copella-topics'),
                ));
                ?>
            </div>
        <?php else : ?>
            <div class="cp-archive-empty">
                <h2><?php _e('Креаторы не найдены', 'copella-topics'); ?></h2>
                <p><?php _e('Пока нет созданных креаторов.', 'copella-topics'); ?></p>
            </div>
        <?php endif; ?>
    </div>
</div>
